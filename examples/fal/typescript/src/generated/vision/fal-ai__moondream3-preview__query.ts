/**
 * Model: Moondream 3 Preview [Query] | Slug: fal-ai/moondream3-preview/query | Category: vision | https://fal.ai/models/fal-ai/moondream3-preview/query
 *
 */
...
export async function run(customInput?: Partial<Input>) {
  ...
  try {
    const result: { data: Output } = await fal.subscribe('fal-ai/moondream3-preview/query', { input });
