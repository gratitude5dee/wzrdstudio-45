/**
 * Model: ElevenLabs TTS Multilingual v2 | Slug: fal-ai/elevenlabs/tts/multilingual-v2 | Category: text-to-audio | https://fal.ai/models/fal-ai/elevenlabs/tts/multilingual-v2
 *
 */
...
export async function run(customInput?: Partial<Input>) {
  ...
  try {
    const result: { data: Output } = await fal.subscribe('fal-ai/elevenlabs/tts/multilingual-v2', { input });
