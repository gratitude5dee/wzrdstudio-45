/**
 * Model: Wan 2.5 Text to Video | Slug: fal-ai/wan-25-preview/text-to-video | Category: text-to-video | https://fal.ai/models/fal-ai/wan-25-preview/text-to-video
 *
 */
...
export async function run(customInput?: Partial<Input>) {
  ...
  try {
    const result: { data: Output } = await fal.subscribe('fal-ai/wan-25-preview/text-to-video', { input });
