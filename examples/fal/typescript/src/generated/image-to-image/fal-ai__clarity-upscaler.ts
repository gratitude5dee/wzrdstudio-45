/**
 * Model: Clarity Upscaler | Slug: fal-ai/clarity-upscaler | Category: image-to-image | https://fal.ai/models/fal-ai/clarity-upscaler
 *
 */
...
export async function run(customInput?: Partial<Input>) {
  ...
  try {
    const result: { data: Output } = await fal.subscribe('fal-ai/clarity-upscaler', { input });
