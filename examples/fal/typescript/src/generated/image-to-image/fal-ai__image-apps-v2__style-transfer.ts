/**
 * Model: Style Transfer | Slug: fal-ai/image-apps-v2/style-transfer | Category: image-to-image | https://fal.ai/models/fal-ai/image-apps-v2/style-transfer
...
export async function run(customInput?: Partial<Input>) {
  ...
  try {
    const result: { data: Output } = await fal.subscribe('fal-ai/image-apps-v2/style-transfer', { input });
