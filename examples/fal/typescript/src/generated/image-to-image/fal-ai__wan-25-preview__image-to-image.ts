/**
 * Model: Wan 2.5 Image to Image | Slug: fal-ai/wan-25-preview/image-to-image | Category: image-to-image | https://fal.ai/models/fal-ai/wan-25-preview/image-to-image
 *
 */
...
export async function run(customInput?: Partial<Input>) {
  ...
  try {
    const result: { data: Output } = await fal.subscribe('fal-ai/wan-25-preview/image-to-image', { input });
