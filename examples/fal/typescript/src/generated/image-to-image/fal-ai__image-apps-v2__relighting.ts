/**
 * Model: Relighting | Slug: fal-ai/image-apps-v2/relighting | Category: image-to-image | https://fal.ai/models/fal-ai/image-apps-v2/relighting
...
export async function run(customInput?: Partial<Input>) {
  ...
  try {
    const result: { data: Output } = await fal.subscribe('fal-ai/image-apps-v2/relighting', { input });
