/**
 * Model: Lynx | Slug: fal-ai/lynx | Category: image-to-video | https://fal.ai/models/fal-ai/lynx
...
export async function run(customInput?: Partial<Input>) {
  const input: Input = {
    prompt: "The white dragon warrior stands still,...mination",
    image_url: "https://example.com/input.jpg"
  } as Input;

  try {
    const result: { data: Output } = await fal.subscribe('fal-ai/lynx', { input });
